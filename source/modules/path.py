...
TableStat_path = "F:/project/mini_project/StudyApp/data/Table Stat.md" #Used
PDF_index_path = "F:/project/mini_project/StudyApp/data/PDF index.md" #Used
TagCatalog_path = "F:/project/mini_project/StudyApp/data/Tag Catalog.md" #Used

Obsidian_TableStat_path = "F:/project/StudyLog/Dashboard/Table Stat.md"
Obsidian_PDF_index_path = "F:/project/StudyLog/Dashboard/PDF index.md"
