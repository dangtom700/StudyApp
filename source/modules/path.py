...
Obsidian_root_path = "Destination\\to\\Obsidian\\"
...
BOOKS_folder_path = Obsidian_root_path + "BOOKS" #Used
Obsidian_TableStat_path = Obsidian_root_path + "Table Stat.md" #Used
Obsidian_PDF_index_path = Obsidian_root_path + "PDF index.md" #Used
Obsidian_TagCatalog_path = Obsidian_root_path + "Tag Catalog.md" #Used
Obsidian_taskList_path = Obsidian_root_path + "Task List.md" #Used